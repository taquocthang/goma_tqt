...
import BookingServiceDetail from "../../modules/Services/BookingServiceDetail";
...
const HomeStack = () => {
	return (
		<Stack.Navigator initialRouteName="HomeScreen" backBehavior={'HomeScreen'} headerMode="none" >
			...
			<Stack.Screen name="BookingServiceDetail" component={BookingServiceDetail} options={{ headerShown: false }} />
		</Stack.Navigator>
	);
}
